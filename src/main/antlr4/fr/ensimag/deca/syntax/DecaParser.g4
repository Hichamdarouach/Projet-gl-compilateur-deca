...
@init {
    ...
    : if1=IF OPARENT condition=expr CPARENT OBRACE li_if=list_inst CBRACE {
      ...
      (ELSE elsif=IF OPARENT elsif_cond=expr CPARENT OBRACE elsif_li=list_inst CBRACE {
        ListInst new_li = new ListInst();
        IfThenElse tree_elsif = new IfThenElse($elsif_cond.tree, $elsif_li.tree, new_li);
        li.add(tree_elsif);
        setLocation(tree_elsif, $elsif);
        li = new_li;
        }
      )*
...
class_decl returns[AbstractDeclClass tree]
    : CLASS name=ident superclass=class_extension OBRACE class_body CBRACE {
            ...
            setLocation($name.tree, $ident.start);
        }
    ;
...
@init {
    ...
    : (m=decl_method {
      ...
      | decl_field_set {
            ...
            $fields.addAllListe($decl_field_set.tree);
        }
      )*
    ;

decl_field_set returns[ListDeclField tree]
    : v=visibility t=type list_decl_field[$v.visib, $t.tree]
      SEMI {
...
@init {
    ...
    : type ident OPARENT params=list_params CPARENT (block {
            ...
            $tree = new DeclMethod($type.tree, $ident.tree, $params.l, body);
      ...
      | ASM OPARENT code=multi_line_string CPARENT SEMI {
            ...
            MethodAsmBody body = new MethodAsmBody(string);
...
multi_line_string returns[String text, Location location]
    : s=STRING {
            $text = $s.text.substring(1, $s.text.length()-1);
